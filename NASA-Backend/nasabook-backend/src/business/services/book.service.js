...
class BookService {
    ...
    /**
     * Soft deletes multiple books based on a list of IDs.
     * @param {string[]} bookIds - An array of book IDs to soft delete.
     * @returns {Promise<number>} The number of books that were successfully soft deleted.
     */
